...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-12-2025 a las 06:47:56
...
--
-- Estructura de tabla para la tabla `user_cred`
--
...
--
-- AUTO_INCREMENT de la tabla `user_cred`
--
ALTER TABLE `user_cred`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
