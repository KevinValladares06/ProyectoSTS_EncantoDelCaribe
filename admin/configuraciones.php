                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            ...
                            <button type="button" class= "btn-dark shadow-none btn-sm"
                                    class="btn btn-dark shadow-none btn-sm" data-bs-toggle="modal" data-bs-target="#general-s">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            ...
                            <div class="form-check form-switch">
                                <form>
                            <input onchange="upd_shutsown(this.value)" class="form-check-input" type="checkbox" id="shutdown_toggle">
                            </form>
                            </div>
